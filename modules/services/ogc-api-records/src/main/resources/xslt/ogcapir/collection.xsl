<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/">
    ...
    <xsl:variable name="serviceMetadataInfo"
                  select="parse-xml($collection/serviceRecord)/node()"
                  as="node()*"/>
    ...
    <html>
      ...
      <div style="display:flex;flex-direction:row;padding-top:8px">
        ...
        <div>
          <div style="font-size:30px;padding-top:10px">View Records</div>
          <a style="font-size:22px;text-decoration: underline;color:rgb(28, 118, 209)" href="{$requestUrl}/items">View Records in this Portal</a>
        </div>
